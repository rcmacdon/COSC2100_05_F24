...
namespace Week12Demo_DatabaseStuffFinal {
    ...
    public partial class SportleaguesDataSet : global::System.Data.DataSet {
        ...
        public partial class teamsDataTable : global::System.Data.TypedTableBase<teamsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public teamsRow AddteamsRow(int teamid, string teamname, int isactive) {
...
namespace Week12Demo_DatabaseStuffFinal.SportleaguesDataSetTableAdapters {
    ...
    public partial class teamsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [teams] WHERE (([teamid] = @Original_teamid) AND ((@IsNull_teamname =" +
                " 1 AND [teamname] IS NULL) OR ([teamname] = @Original_teamname)) AND ((@IsNull_i" +
                "sactive = 1 AND [isactive] IS NULL) OR ([isactive] = @Original_isactive)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [teams] ([teamid], [teamname], [isactive]) VALUES (@teamid, @teamname" +
                ", @isactive);\r\nSELECT teamid, teamname, isactive FROM teams WHERE (teamid = @tea" +
                "mid)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [teams] SET [teamid] = @teamid, [teamname] = @teamname, [isactive] = @isactive WHERE (([teamid] = @Original_teamid) AND ((@IsNull_teamname = 1 AND [teamname] IS NULL) OR ([teamname] = @Original_teamname)) AND ((@IsNull_isactive = 1 AND [isactive] IS NULL) OR ([isactive] = @Original_isactive)));
SELECT teamid, teamname, isactive FROM teams WHERE (teamid = @teamid)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Week12Demo_DatabaseStuffFinal.Properties.Settings.Default.SportleaguesConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT teamid, teamname, isactive\r\nFROM   teams\r\nWHERE (isactive = 1)";
        ...
        public virtual int Delete(int Original_teamid, string Original_teamname, global::System.Nullable<int> Original_isactive) {
        ...
        public virtual int Insert(int teamid, string teamname, global::System.Nullable<int> isactive) {
        ...
        public virtual int Update(int teamid, string teamname, global::System.Nullable<int> isactive, int Original_teamid, string Original_teamname, global::System.Nullable<int> Original_isactive) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string teamname, global::System.Nullable<int> isactive, int Original_teamid, string Original_teamname, global::System.Nullable<int> Original_isactive) {
            return this.Update(Original_teamid, teamname, isactive, Original_teamid, Original_teamname, Original_isactive);
        }
    }
